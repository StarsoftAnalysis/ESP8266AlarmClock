...
<body>
    ...
    <main role="main">
        ...
        <p>When you click on 'Save' with at least one SSID entered, the alarm clock will revert to, or stay in, 'station' mode and attempt to connect to the network.
        ...
        <p><button class="btn btn-primary mt-3" type=button id=saveSettings>Save</button> <span id="statusMsg"></span>
