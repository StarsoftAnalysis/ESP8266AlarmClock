            ...
            <div bsclass=form-group>
                <div bsclass="form-row">
                    <div bsclass="col-auto">
                        <label for=melody bsclass="h3 mt-3">RTTTL Melody</label>
                        <textarea id=melody bsclass="form-control" rows="5" cols="60" maxlength=500></textarea>
                    </div>
                    <div bsclass="col-auto">
                        <label for=tz bsclass="h3 mt-3">Timezone</label>
                        <input type=text id=tz bsclass="form-control" maxlength=32>
                    </div>
                </div>
                ...
                <div bsclass="form-row">
                    <div bsclass="col-auto">
                        <button bsclass="btn btn-primary mt-3" type=button id=saveSettings>Save</button>
