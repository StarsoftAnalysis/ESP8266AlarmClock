...
<body bsclass="d-flex flex-column h-100">
<nav bsclass="navbar navbar-expand-md navbar-dark bg-dark">
  <div bsclass="container">
      <h1 bsclass="text-white mb-0"><!-- clock.svg --><svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="28" viewBox="0 0 24 28"><path d="M14 8.5v7c0 0.281-0.219 0.5-0.5 0.5h-5c-0.281 0-0.5-0.219-0.5-0.5v-1c0-0.281 0.219-0.5 0.5-0.5h3.5v-5.5c0-0.281 0.219-0.5 0.5-0.5h1c0.281 0 0.5 0.219 0.5 0.5zM20.5 14c0-4.688-3.813-8.5-8.5-8.5s-8.5 3.813-8.5 8.5 3.813 8.5 8.5 8.5 8.5-3.813 8.5-8.5zM24 14c0 6.625-5.375 12-12 12s-12-5.375-12-12 5.375-12 12-12 12 5.375 12 12z"></path></svg> Alarm Clock</h1>
  </div>
</nav>
<main role="main">
  <div bsclass="container">
    <div bsclass=form-group>
      <div bsclass="form-row">

        <div bsclass="col-auto">
          <h2 bsclass="mt-3">Set the alarm</h2>
          <table bsclass=table-sm>
            <tr><th>Day</th><th>Alarm Time</th><th>Set?</th></tr>
            <tr>
                <td><label for="time0" bsclass="form-label">Sunday</label></td>
                <td><input id="time0" type="time" bsclass="form-control alarmField" aria-label="Alarm time Sunday"></td>
                <td><input id="set0" bsclass="form-check-input alarmField" type="checkbox" aria-label="Alarm set Sunday"></td>
            </tr> 
            <tr>
                <td><label for="time1" bsclass="form-label">Monday</label></td>
                <td><input id="time1" type="time" bsclass="form-control alarmField" aria-label="Alarm time Monday"></td>
                <td><input id="set1" bsclass="form-check-input alarmField" type="checkbox" aria-label="Alarm set Monday"></td>
            </tr> 
            <tr>
                <td><label for="time2" bsclass="form-label">Tuesday</label></td>
                <td><input id="time2" type="time" bsclass="form-control alarmField" aria-label="Alarm time Tuesday"></td>
                <td><input id="set2" bsclass="form-check-input alarmField" type="checkbox" aria-label="Alarm set Tuesday"></td>
            </tr> 
            <tr>
                <td><label for="time3" bsclass="form-label">Wednesday</label></td>
                <td><input id="time3" type="time" bsclass="form-control alarmField" aria-label="Alarm time Wednesday"></td>
                <td><input id="set3" bsclass="form-check-input alarmField" type="checkbox" aria-label="Alarm set Wednesday"></td>
            </tr> 
            <tr>
                <td><label for="time4" bsclass="form-label">Thursday</label></td>
                <td><input id="time4" type="time" bsclass="form-control alarmField" aria-label="Alarm time Thursday"></td>
                <td><input id="set4" bsclass="form-check-input alarmField" type="checkbox" aria-label="Alarm set Thursday"></td>
            </tr> 
            <tr>
                <td><label for="time5" bsclass="form-label">Friday</label></td>
                <td><input id="time5" type="time" bsclass="form-control alarmField" aria-label="Alarm time Friday"></td>
                <td><input id="set5" bsclass="form-check-input alarmField" type="checkbox" aria-label="Alarm set Friday"></td>
            </tr> 
            <tr>
                <td><label for="time6" bsclass="form-label">Saturday</label></td>
                <td><input id="time6" type="time" bsclass="form-control alarmField" aria-label="Alarm time Saturday"></td>
                <td><input id="set6" bsclass="form-check-input alarmField" type="checkbox" aria-label="Alarm set Saturday"></td>
            </tr> 
          </table>
        </div>

        <div bsclass="col-auto">
          <p bsclass="h4 mt-3"><label for="volume">Volume:</label> <output for="volume" id="volumeOutput"></output>
          <input bsclass="form-control" type="range" name="volume" id="volume" min="0" max="11" step="1" value="5">
        </div>

        <div bsclass="col-auto">
          <h4 bsclass="mt-3">Next Alarm</h4>
          <p><span id=nextSetAlarmIn>...</span></p>
          <p>Next Alarm Cancelled? <input id="nextAlarmCancelled" bsclass="form-check-input alarmField" type=checkbox aria-label="Next Alarm Cancelled"></p>
        </div>

        <div bsclass="col-auto">
          <button bsclass="btn btn-primary mt-3" type=button id=setAlarm>Save</button>
          <span id="statusMsg"></span>
        </div>

        <div bsclass="col-auto">
          <h4 bsclass="mt-3">Current Time</h4>
          <p id=currentTime bsclass="h2 font-weight-bold font-italic">00:00</p>
        </div>
...
<footer bsclass="footer mt-auto bg-light text-dark py-3">
    <div bsclass="container">
      <div bsclass="row">
        <div class=footeritem bsclass="col-sm">
            ...
            Signal Strength: <span id="WiFiValue">...</span>%
        ...
        <div class=footeritem bsclass="col-sm text-left text-sm-right">
            ...
            <a href="https://github.com/starsoftanalysis/ESP8266AlarmClock/" target="_blank">GitHub</a>
        </div>
      </div>
    </div>
</footer>
